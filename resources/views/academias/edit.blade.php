...
@section('content')
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Editar Academia: {{ $academia->nome }}</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
        <form action="{{ route('academias.update', $academia->idAcademia) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="CNPJ" name="CNPJ" value="{{ old('CNPJ', $academia->CNPJ) }}" required placeholder="XX.XXX.XXX/YYYY-ZZ"
