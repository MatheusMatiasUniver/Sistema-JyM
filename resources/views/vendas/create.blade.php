                                        ...
                                        <tr class="product-row hover:bg-gray-50" data-product-id="{{ $produto->idProduto }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                    {{ $produto->estoque <= 5 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800' }}">
                                                    {{ $produto->estoque }} unidades
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" 
                                                       class="quantity-input w-20 px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                       data-product-id="{{ $produto->idProduto }}"
                                                       min="1" 
                                                       max="{{ $produto->estoque }}" 
                                                       value="1"
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select id="idCliente" name="idCliente" required
                                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('idCliente') border-red-500 @enderror">
                                ...
                                <div id="clienteInfo" class="hidden p-3 bg-blue-50 rounded-lg border border-blue-200">
                                    <h4 class="text-sm font-medium text-blue-900 mb-2">Informações do Cliente</h4>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6">
                            ...
                            <div>
                                ...
                                <select id="formaPagamento" name="formaPagamento" required
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('formaPagamento') border-red-500 @enderror">
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6">
                            ...
                            <div class="mt-4 space-y-2 text-xs">
                                <div id="validationProducts" class="flex items-center text-red-500">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
                                    </svg>
                                    Selecione pelo menos um produto
                                </div>
                                <div id="validationClient" class="flex items-center text-red-500">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
                                    </svg>
                                    Selecione um cliente
                                </div>
                                <div id="validationPayment" class="flex items-center text-red-500">
                                    <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path>
                                    </svg>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateValidation() {
                ...
                if (isValid) {
                    btnRegistrarVenda.className = 'w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200';
                } else {
