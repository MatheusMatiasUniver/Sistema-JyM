                        ...
                        <div class="p-4 bg-gray-50 border-b border-gray-200">
                            <div class="relative">
                                <input type="text" 
                                       ...
                                       class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-grip-1 focus:border-grip-1">
                                ...
                                <tbody id="productsTableBody" class="bg-white divide-y divide-gray-200">
                                    @foreach($produtos as $produto)
                                        <tr class="product-row hover:bg-gray-50" data-product-id="{{ $produto->idProduto }}">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <input type="number" 
                                                       class="quantity-input w-20 px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-grip-1 focus:border-grip-1"
                                                       data-product-id="{{ $produto->idProduto }}"
                                                       min="1" 
                                                       max="{{ $produto->estoque }}" 
                                                       value="1"
