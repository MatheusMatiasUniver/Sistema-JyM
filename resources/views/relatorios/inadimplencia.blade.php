...
@section('title', 'Relatório de Inadimplência de Mensalidades - Sistema JyM')
...
@section('content')
    <x-relatorio-header 
        titulo="Relatório de Inadimplência de Mensalidades" 
        modulo="Financeiro" 
        pdf-route="relatorios.inadimplencia.pdf" 
    />
