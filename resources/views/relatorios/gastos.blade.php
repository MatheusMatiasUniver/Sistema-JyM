...
@section('content')
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden mb-6">
        <div class="px-5 py-4 border-b bg-gray-50">
            <span class="text-lg font-semibold text-gray-700">Total Geral: R$ {{ number_format($totalGeral,2,',','.') }}</span>
        </div>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="6" class="px-5 py-5 border-b bg-white text-sm text-center text-gray-500">Sem dados.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
