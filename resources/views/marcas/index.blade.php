    ...
    <div class="mb-4 flex justify-between items-center">
        ...
        <form action="{{ route('marcas.index') }}" method="GET" class="flex gap-3 items-end">
            ...
            <div>
                ...
                <select id="ativo" name="ativo" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
