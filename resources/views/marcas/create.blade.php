...
@section('title', 'Cadastrar Marca - Sistema JyM')

@section('content')
    <h1 class="text-3xl font-bold mb-6 text-grip-6">Cadastrar Nova Marca</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
        <form action="{{ route('marcas.store') }}" method="POST" autocomplete="off">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="paisOrigem" name="paisOrigem" value="{{ old('paisOrigem') }}"
            ...
            <div class="mb-6">
                <label class="inline-flex items-center">
                    <input type="checkbox" name="ativo" value="1" class="form-checkbox h-5 w-5 text-black" {{ old('ativo', '1') ? 'checked' : '' }}>
                    <span class="ml-2 text-gray-700">Ativo</span>
                </label>
            </div>

            <div class="flex items-center justify-between">
                <button type="submit" class="bg-grip-1 hover:bg-grip-2 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Cadastrar Marca</button>
