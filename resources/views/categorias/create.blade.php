        ...
        <form action="{{ route('categorias.store') }}" method="POST" autocomplete="off">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" id="nome" name="nome" value="{{ old('nome') }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 bg-white text-black" placeholder="Digite o nome da categoria" maxlength="100" required>
                    @error('nome')
